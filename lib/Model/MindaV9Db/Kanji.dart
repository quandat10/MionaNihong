...
Kanji clientFromJson(String str) {
  final jsonData = json.decode(str);
  return Kanji.fromMap(jsonData);
}

String clientToJson(Kanji data) {
...
//  int score;
  ...
  Kanji({this.id, this.word, this.lesson, this.cn_mean, this.onjomi,
    this.kunjomi, this.image, this.remember, this.remember_jp, this.note, this.vi_mean,this.numstroke});

  factory Kanji.fromMap(Map<String, dynamic> json) =>
      new Kanji(
        id: json["id"],
        word: json["word"],
        lesson: json["lesson"],
